...
const Socials = () => {
    return (
        <div className="flex py-6 space-x-4">
            <a className="group -m-1 p-1" aria-label="Follow on Instagram" href="https://instagram.com" target="_blank">
            ...
            <a className="group -m-1 p-1" aria-label="Follow on GitHub" href="https://github.com" target="_blank">
                <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
